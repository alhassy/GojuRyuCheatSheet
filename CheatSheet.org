...
#+MACRO: URL https://alhassy.com/GojuRyuCheatSheet/CheatSheet.pdf
#+MACRO: ShowURL @@latex:{\tiny\hspace{1em}\url{ {{{URL}}} } }@@
...
#+AUTHOR: The Martial Arts Center  {{{ShowURL}}}
...
+ Joey Jackson, 4th Dan :: Sensei of [[https://niagaramartialarts.com/][The Martial Arts Center]].
